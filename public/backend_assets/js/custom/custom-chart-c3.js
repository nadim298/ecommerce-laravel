...
$(document).ready(function() {
    ...
    var scatterPlotChart = c3.generate({
        ...
        color: { pattern: ["#e9eff9", "#ffe411", "#944dff"] },
        data: {
            xs: {
                setosa: 'setosa_x',
    ...
    var stackedBarChart = c3.generate({
        ...
        color: { pattern: ["rgba(255,255,255,0.05)", "#944dff", "#ffe411"] },
        data: {
            columns: [
    ...
    var combinationChart = c3.generate({
        ...
        color: { pattern: ["#944dff", "rgba(255,255,255,0.05)", "#fc4f68", "#08d26f", "#ffe411", "#81cef6"] },
        data: {
            columns: [
    ...
    var gaugeChart = c3.generate({
        ...
        color: {
            pattern: ['#ffe411', '#08d26f', '#fc4f68', '#944dff'],
            threshold: {
                values: [30, 60, 90, 100]
            }
        },
    ...
    var pieChart = c3.generate({
        bindto: '#c3-pie',
        color: { pattern: ["#944dff", "rgba(255,255,255,0.05)", "#ffe411"] },
        data: {
            columns: [
                ['SeriesA', 40],
                ['SeriesB', 25],
